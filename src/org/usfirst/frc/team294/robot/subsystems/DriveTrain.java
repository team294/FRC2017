...
public class DriveTrain extends Subsystem {
	...
	//Current protection
	CANTalon[] rightMotorList = {rightMotor1, rightMotor2, rightMotor3};
	CANTalon[] leftMotorList = {leftMotor1, leftMotor2, leftMotor3};
	//TODO:  ADRESSED, WE NEED TO TEST IT THOUGH Fix MotorGroupCurrentTrigger
