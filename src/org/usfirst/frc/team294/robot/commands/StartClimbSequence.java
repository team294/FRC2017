...
public class StartClimbSequence extends CommandGroup {
    ...
    public StartClimbSequence() {
    	...
    	addSequential(new ClimbSetToSpeed(.8));			//  test this.  If it works increase to 1.0
    	addSequential(new WaitSeconds(1));				// Rob added after analyzing current graph from last night
    	addSequential(new CheckClimberCurrent(30));		// We had increased this to 38 because it stopped here, but we didn't have delay - try 30 and measure
