...
public class ProfileGenerator {
	...
	public ProfileGenerator(double initialPosition, double finalPosition, double initialVelocity, double maxVelocity,
			double currentAcceleration, double maxAcceleration, double dt, double totalTime) {
	...
	public double getCurrentCommand(){
		double stoppingDistance = currentVelocity*currentVelocity/maxAcceleration;
