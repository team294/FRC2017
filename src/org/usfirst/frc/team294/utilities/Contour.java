...
public class Contour {
	private double xPos, yPos, area, height, width, radius, hardness;
	private boolean eliminated = false;
	
	//constructor
	public Contour(double xPos, double yPos, double area, double height, double width, double hardness) {
	...
	public Contour() {this.xPos = this.yPos = this.area = this.height = this.radius = this.hardness = 0; }
